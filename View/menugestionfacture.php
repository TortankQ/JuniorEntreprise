...
<div>
    <form id="consulterediterfacture" method="POST" action="../Controller/MenugestionfactureController.php">
        <button type="submit" name="btnConsulterEditerFacture">consulter/editer factures</button>
    </form>
</div>
<div>
